...
var PurchasedPage = /** @class */ (function () {
    function PurchasedPage(route, screenOrientation, statusBar, userDb, MyPipe) {
        this.route = route;
