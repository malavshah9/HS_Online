...
var UserDbService = /** @class */ (function () {
    function UserDbService(httpClient) {
        ...
        this.urlCheckBalance = "https://honestonline.in/api/index.php/winbalance/";
        this.urlTakeBalance = "https://honestonline.in/api/index.php/takebalance/";
    }
    ...
    UserDbService.prototype.takeBalance = function (uid) {
    ...
    UserDbService.prototype.checkBalance = function (uid) {
