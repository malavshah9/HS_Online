    ...
    onClick() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (newPassword === confirmNewPassword) {
                let pasword = new _shared_Password_class__WEBPACK_IMPORTED_MODULE_6__["Password"](this.changeForm.get('oldPassword').value, newPassword);
                let userId = localStorage.getItem('UserId');
                this.useDb.changePassword(pasword, userId).subscribe((data) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                    console.log(data);
                    if (data.result) {
                        this.route.navigateByUrl('/dashboard');
                        let t2 = yield this.toast.create({
                        ...
                        let t3 = yield this.toast.create({
...
class Password {
    constructor(user_password, user_password_new) {
