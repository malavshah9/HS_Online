...
var ProgramPage = /** @class */ (function () {
    function ProgramPage(route, statusBar, screenOrientation, userDb, programDb, alertController, toastController, zone, MyPipe) {
        this.route = route;
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.zone.run(function () {
                    _this.userDb.getBalance(_this.userId).subscribe(function (data) {
                        _this.myObj = data;
                    });
                });
                return [2 /*return*/];
    ...
    ProgramPage.prototype.takeBalance = function () {
        var _this = this;
        this.userDb.takeBalance(localStorage.getItem("UserId")).subscribe(function (data) {
            _this.winBalance = data;
        });
    };
    ProgramPage.prototype.checkBalance = function () {
        var _this = this;
        this.userDb.checkBalance(localStorage.getItem("UserId")).subscribe(function (data) {
            _this.winBalance = data;
        });
    };
    ...
    ProgramPage.prototype.isNullOrZero = function () {
...
var Balance = /** @class */ (function () {
    function Balance(result, reason, UserBalance) {
        this.result = result;
        this.reason = reason;
